...
exports.HistoryPanel = exports.ChatTreeItem = void 0;
...
class HistoryPanel {
    constructor(storage) {
        ...
        // Register commands
        vscode.commands.registerCommand('codabra.deleteChat', async (item) => {
            try {
                await this.storage.update('codabra-chats', this.storage.get('codabra-chats', []).filter(chat => chat.id !== item.chat.id));
                this.refresh();
            }
            catch (error) {
